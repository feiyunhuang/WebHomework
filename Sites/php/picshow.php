    ...
    <div class="container gallery-container">
        ...
        <div class="tz-gallery">
            ...
            <div class="row">
                    ...
                    $db = new SQLite3('/Users/huangyunfei/Sites/db/picwalldb.db');
                    $uid=$_COOKIE['uid'];
                    $sql ="select pid,description,zan from pictures WHERE pownerid = $uid ORDER BY zan DESC ";
                    $ret = $db->query($sql);
                    while($row = $ret->fetchArray(SQLITE3_ASSOC) ){
                    ...
                    ?>
                        ...
                        my description:
                        <?php echo $de;?>
                        <a href="deletepicture.php?pid=<?php echo substr($pid,0,strlen($pid)-4); ?>&type=<?php echo substr($pid,-3); ?>"><button class="btn btn-sm btn-primary" type="button">删除</button></a>
